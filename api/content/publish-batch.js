...
import { publishContentBatch } from "../_lib/services/content.js";
...
export default async function handler(req, res) {
  ...
  try {
    return res.status(200).json(await publishContentBatch(ids));
  } catch (err) {
    return handleServerError(res, err, "Batch publish");
  }
}
